	...
	<div id="menu_pane">
				...
				<ul>
				  <?php if($this->session->userdata('role_log_id')!=6):?>
					<li><a id="arec_btn" class="doc_cat" href="#"><img src='<?php echo base_url();?>ext_lib/images/icon/record.png' alt='' title='Document Records'/>Document Records</a></li>
				  <?php endif;?>
				  <?php if($this->session->userdata('div_log_id')==1 OR strpos($this->session->userdata('div_log_alias'),'C-')!==false):?>
					<li><div id="4" class="doc_count" style="margin:8px 0px 0px 140px;border:1px solid white"></div><a id="rt_btn" class="doc_cat" href="#"><img src='<?php echo base_url();?>ext_lib/images/icon/route.png' alt='' title='For Routing'/>For Routing</a></li>
				  <?php endif;?>
				  
				  <?php if($this->session->userdata('div_log_id')==1):?>
					<li><div id="5" class="doc_count" style="margin:8px 0px 0px 140px;border:1px solid white"></div><a id="return_btn" class="doc_cat" href="#"><img src='<?php echo base_url();?>ext_lib/images/icon/return.png' alt='' title='Rerouted'/>Returned</a></li>
				  <?php endif;?>
				  ...
				  <?php if($this->session->userdata('div_log_id')!=1 AND strpos($this->session->userdata('div_log_alias'),'C-')===false AND $this->session->userdata('role_log_id')!=6):?>
					<li><div id="1" class="doc_count" style="margin:8px 0px 0px 140px;border:1px solid white"></div><a id="int_btn" class="doc_cat" href="#"><img src='<?php echo base_url();?>ext_lib/images/icon/transit.png' alt='' title='In Transit'/>In Transit</a></li>
				  <?php endif;?>
				  <?php if($this->session->userdata('div_log_id')!=1):?>
					<li><div id="2" class="doc_count" style="margin:8px 0px 0px 140px;border:1px solid white"></div><a id="inp_btn" class="doc_cat" href="#"><img src='<?php echo base_url();?>ext_lib/images/icon/progress.png' alt='' title='In Progess'/>In Progess</a></li>
				  <?php endif;?>
					<li><div id="6" class="doc_count" style="margin:8px 0px 0px 140px;border:1px solid white"></div><a id="actk_btn" class="doc_cat" href="#"><img src='<?php echo base_url();?>ext_lib/images/icon/action.png' alt='' title='For Action'/>For Action</a></li>
				  <?php if($this->session->userdata('role_log_id')!=6):?>
					<li><a id="arc_btn" class="doc_cat" href="#"><img src='<?php echo base_url();?>ext_lib/images/icon/archive.png' alt='' title='Archived'/>Archived</a></li>
					<li><a id="rep_btn" href="#"><img src='<?php echo base_url();?>ext_lib/images/icon/transit.png' alt='' title='Archived'/>Reports</a></li>
				  <?php endif;?>
				</ul>
